function drawRulesSection() {
 ...
 const rules = 
    ...
    text(rules, centerX + 100, centerY + 60);
}
...
class Spejder {
    ...
    loadAnimationFrames() {
        ...
        for (let i = 1; i <= 24; i++) {
            ...
            this.framesLeft.push(loadImage(`images/startpage/p4spider/${frameName}.png`));
        }

        // Load right-facing frames
        for (let i = 1; i <= 24; i++) {
            const frameName = `p4spejderR${i}`;
            this.framesRight.push(loadImage(`images/startpage/p4spider/${frameName}.png`));
        }
    }
...
class ImageIndex8Manager {
    ...
    loadImages() {
        ...
        for (let i = 1; i <= 6; i++) {
            ...
            this.warpgateAImages.push(loadImage(`images/startpage/p3warpgateA/${frameName}.png`));
        }

        // Load warpgate B images
        for (let i = 1; i <= 13; i++) {
            const frameName = `p3warpgateB${i}`;
            this.warpgateBImages.push(loadImage(`images/startpage/p3warpgateB/${frameName}.png`));
        }
    }
...
class ImageIndex11Manager {
    ...
    loadImages() {
        ...
        for (let i = 1; i <= 13; i++) {
            ...
            this.warpgateImages.push(loadImage(`images/startpage/p4warpgateA/${frameName}.png`));
        }

        // Load lightTower images
        for (let i = 1; i <= 11; i++) {
            const frameName = `p4lightTower${i}`;
            this.lightTowerImages.push(loadImage(`images/startpage/p4lightTower/${frameName}.png`));
        }
    }
...
class ImageIndex13Manager {
    ...
    loadImages() {
        ...
        this.jellyfishImages.push(loadImage("images/startpage/p4p3jellyfish/p4p3jellyfishLeft.png"));
        this.jellyfishImages.push(loadImage("images/startpage/p4p3jellyfish/p4p3jellyfishLowerLeft.png"));
        this.jellyfishImages.push(loadImage("images/startpage/p4p3jellyfish/p4p3jellyfishLowerMiddle.png"));
        this.jellyfishImages.push(loadImage("images/startpage/p4p3jellyfish/p4p3jellyfishLowerRight.png"));
        this.jellyfishImages.push(loadImage("images/startpage/p4p3jellyfish/p4p3jellyfishUpperLeft.png"));
        this.jellyfishImages.push(loadImage("images/startpage/p4p3jellyfish/p4p3jellyfishUpperRight.png"));
...
class ImageIndex16Manager {
    ...
    loadImages() {
        ...
        for (let i = 1; i <= 10; i++) {
            ...
            this.warpgateImages.push(loadImage(`images/startpage/p0warpgateA/${frameName}.png`));
        }

        // Load warpgate images
        for (let i = 1; i <= 6; i++) {
            const frameName = `p0water${i}`;
            this.waterImages.push(loadImage(`images/startpage/p0water/${frameName}.png`));
        }
...
class ImageIndex10Manager {
    ...
    loadImagesAndAddSpacecrafts() {
        ...
        this.backgroundImage = loadImage("images/startpage/hangerTeamBlueEffect/hangerTeamBlueEmpty1.png");

        // Load spacecraft images and create spacecraft objects
        const blackCircleImg = loadImage("images/startpage/hangerTeamBlueEffect/blackCircleDownLeft1.png");
        const upperLeftImg = loadImage("images/startpage/hangerTeamBlueEffect/spaceCraftUpperLeft.png");
        const upperRightImg = loadImage("images/startpage/hangerTeamBlueEffect/spaceCraftUpperRight.png");
        const lowerLeftImg = loadImage("images/startpage/hangerTeamBlueEffect/spaceCraftLowerLeft.png");
        const lowerRightImg = loadImage("images/startpage/hangerTeamBlueEffect/spaceCraftLowerRight.png");
